...
public class Gangorra {
    public static void main(String[] args) {
        ...
        String gangorra [] = sc.nextLine().split(" ");
        int peso1 = Integer.parseInt(gangorra[0]);
        int comprimento1 = Integer.parseInt(gangorra[1]);
        int peso2 = Integer.parseInt(gangorra[2]);
        int comprimento2 = Integer.parseInt(gangorra[3]);
        int ladoEsquerdo = peso1*comprimento1;
        int ladoDireito = peso2*comprimento2;
