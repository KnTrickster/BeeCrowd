...
public class AvioesDePapel {
    public static void main(String[] args) {
        ...
        int competidores = Integer.parseInt(dados[0]);
        int folhasContidas = Integer.parseInt(dados[1]);
        int folhasReceber = Integer.parseInt(dados[2]);

        int divisao = folhasContidas/competidores;
        if (divisao>=folhasReceber){
